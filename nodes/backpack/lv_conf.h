...
#define LV_FONT_DEFAULT        &lv_font_dejavu_60     /*Always set a default font from the built-in fonts*/
...
#define USE_LV_FONT_DEJAVU_60_SUP          1
#define USE_LV_FONT_DEJAVU_60_LATIN_EXT_A  1
#define USE_LV_FONT_DEJAVU_60_LATIN_EXT_B  1
#define USE_LV_FONT_DEJAVU_60_CYRILLIC     1
